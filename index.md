...
instructor: ["Daniel Ouso"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes: [Notes Etherpad](https://pad.carpentries.org/icipe-mbbu_2019-11-27_dc-genomics)  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p>
  This worshop will be run on an Amazon Web Service (AWS) in a pre-imaged instance on an Amazon Machne Image (AMI) will all the data and core softwares. In addition, you will need an up-to-date web browser.
</p>
<p>
